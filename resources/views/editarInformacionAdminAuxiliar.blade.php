...
<body>
    ...
    <div class="profile-container">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('usuario.update.adminaux') }}">
            @csrf
            <input type="hidden" name="origen" value="{{ $origen ?? 'administrador' }}">
            ...
            <div class="btn-group">
                ...
                <a href="{{ $origen === 'auxiliar' ? route('soporte') : route('administrador') }}">
